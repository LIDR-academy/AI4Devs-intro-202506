Actua como un experto en programacion y crea una interface web en index.html segun la imagen de ejemplo en reversestring-example.png bajo las siguiente indicaciones y funcionalidades que se deben cumplir: Crea una página web con lógica en javascript que invierta el orden de una cadena de texto.
